...
test('addTodo should add teh passed todo to the list', () => {
  const startTodos = [
...
test('findById should return the expeted item form an array', () => {
  const startTodos = [
    {id: 1, name: 'one', isComplete: false},
    {id: 2, name: 'two', isComplete: false},
    {id: 3, name: 'three', isComplete: false}
...
test('toggleTodo should toggle teh isComplete prop of a todo', () => {
...
test('filterTodos should return noly completed items for the complete route', () => {
  const startTodos = [
    {id: 1, name: 'one', isComplete: false},
    {id: 2, name: 'two', isComplete: true},
    {id: 3, name: 'three', isComplete: false}
...
test('filterTodos should return noly incompleted items for the active route', () => {
  const startTodos = [
    {id: 1, name: 'one', isComplete: false},
    {id: 2, name: 'two', isComplete: true},
    {id: 3, name: 'three', isComplete: false}
